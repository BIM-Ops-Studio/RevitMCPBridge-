"""
Test creating a single wall with createWall method
"""
...
# Try creating a single wall with createWall method
print("\nAttempting to create single wall...")
wall_params = {
    "startPoint": [0, 0, 0],
    "endPoint": [45.333, 0, 0],
    "levelId": level_id,
...
print("\nSending request:")
print(json.dumps(wall_params, indent=2))

result = send_mcp_command("createWall", wall_params)
